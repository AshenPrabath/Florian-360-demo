...
// 1. Restore the missing useMemo import if needed
...
// 2. Fix the 100dvh mobile URL bar issue using absolute overlay perfectly tailored for screen boundary
content = content.replace(
...
if (viewpointRegex.test(content)) {
...
if (content.match(tourControlsPropsRegex)) {
...
if (content.match(mobileRow3Regex)) {
